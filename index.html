      ...
      <header class="header">
        ...
        <div class="header-content">
          ...
          <button
            ...
            style="right: 60px; background: rgba(255, 0, 0, 0.2)"
      ...
      <div class="container">
        ...
        <div class="tab-content" id="cadastro">
          <div class="cadastro-toggle">
            ...
            >
              <i class="fas fa-mouse"></i> Acessório
            </button>
            <button
            ...
            >
              <i class="fas fa-tint"></i> Cartucho
            </button>
          </div>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", async function () {
        await tsParticles.load("tsparticles", {
          fullScreen: { enable: false }, // Não ocupa a tela toda, só o header
          background: {
            color: { value: "transparent" }, // Fundo transparente (usa o gradiente do CSS)
          },
          fpsLimit: 60, // Limita o FPS para não pesar
          interactivity: {
            events: {
              onHover: {
                enable: true,
                mode: "grab", // Efeito ao passar o mouse: agarra as partículas próximas
              },
              resize: true,
            },
            modes: {
          ...
          particles: {
            color: { value: "#ffffff" }, // Cor dos pontos (azul claro tecnológico)
            links: {
              color: "#ffffff", // Cor das linhas que conectam
              distance: 150, // Distância máxima para conectar pontos
              enable: true, // Habilita as linhas (o efeito de rede/circuito)
            ...
            move: {
              direction: "none",
              enable: true,
              outModes: { default: "bounce" }, // Bate na borda e volta
              random: false,
              speed: 0.8, // Velocidade lenta e elegante
              straight: false,
            },
            number: {
              density: { enable: true, area: 800 },
              value: 60, // Quantidade de partículas (aumente se quiser mais denso)
            },
            opacity: {
              value: 0.5,
            },
            shape: {
              type: "circle", // Forma dos pontos (pode ser square, triangle, etc)
            },
            size: {
              value: { min: 1, max: 3 }, // Tamanho variado dos pontos
            },
          },
          detectRetina: true,
        });
